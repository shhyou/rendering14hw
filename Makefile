...
EXR_INCLUDES=-I/d/NTUHW/pbrt-v2-master/openexr/include/OpenEXR
EXR_LIBDIR=-L/d/NTUHW/pbrt-v2-master/openexr/lib
...
EXRLIBS=$(EXR_LIBDIR) -Bstatic -lIex -lIlmImf -lIlmThread -lImath -lIex -lHalf -Bdynamic -lpthread -lz
#EXRLIBS=$(EXR_LIBDIR)
ifeq ($(ARCH),Linux)
  EXRLIBS += -lpthread
endif
...
TOOLS = bin/bsdftest bin/obj2pbrt
ifeq ($(HAVE_LIBTIFF),1)
    TOOLS += bin/exrtotiff
endif
